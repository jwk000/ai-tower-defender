...
// ============================================================
// 升级框架：普通塔默认 3 级；激光塔、导弹塔、电塔作为后期战略塔开放 5 级。
...
export const TOWER_CONFIGS: Record<TowerType, TowerConfig> = {
  ...
  [TowerType.Cannon]: {
    ...
    upgradeCosts: [55, 620],
    upgradeAtkBonus: [10, 45],
    upgradeRangeBonus: [0, 40],
    color: '#ff8a65',
    buildTime: 2.0,
  ...
  [TowerType.Laser]: {
    ...
    upgradeCosts: [75, 520, 760, 1050],
    upgradeAtkBonus: [3, 10, 8, 10],
    upgradeRangeBonus: [15, 20, 20, 20],
    color: '#e040fb',
    buildTime: 2.0,
    canTargetLowAir: true,
  ...
  [TowerType.Missile]: {
    ...
    canTargetLowAir: false,
    // 后期战略塔：L3 双发质变，L5 三发终局投资。
    upgradeCosts: [130, 980, 1400, 1850],
    upgradeAtkBonus: [30, 110, 60, 80],
...
export const UNIT_CONFIGS: Record<UnitType, UnitConfig> = {
  ...
  [UnitType.Archer]: {
    ...
    critChance: 0.2,
    critMultiplier: 2,
    critSuperChance: 0.05,
    critSuperMultiplier: 3,
    maxLevel: 3,
    upgradeCosts: [40, 60],
  ...
  [UnitType.Mage]: {
    ...
    moveRange: 100,
    splashRadius: 40,
    debuffId: 'arcane_vulnerability',
    debuffAttribute: 'magicResist',
    debuffValue: -0.2,
    debuffDuration: 4,
    debuffIsPercent: true,
    periodicSpellCooldown: 6,
    periodicSpellDamage: 36,
    periodicSpellRadius: 90,
    maxLevel: 3,
    upgradeCosts: [45, 65],
...
export const SKILL_CONFIGS: Record<string, SkillConfig> = {
  ...
  heal: {
    ...
    value: 12,
    buffId: null,
    description: '每1秒治疗范围内HP最低的友方士兵12点生命',
  },
  fireball: {
    id: 'fireball',
    name: '火球术',
