export type DebugActionId = 'toggle_bg_image' | 'toggle_art_resources' | 'complete_all_levels' | 'add_gold' | 'open_inspector' | 'open_level_editor' | 'show_card_list' | 'skip_to_victory' | 'skip_to_defeat';
