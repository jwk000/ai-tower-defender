...
export const Attack = defineComponent({
  ...
  isRanged: Types.ui8,         // 是否远程攻击 (0=近战, 1=远程)
  canTargetLowAir: Types.ui8,  // 是否能主动选择/命中 LowAir 目标
...
export const Projectile = defineComponent({
  ...
  debuffSlot: Types.ui8,
  debuffValue: Types.f32,
  debuffDuration: Types.f32,
  debuffIsPercent: Types.ui8,
...
/** DOT状态 — 火塔/毒塔DOT伤害时挂载，驱动灼烧/中毒视觉特效 */
export const Poisoned = defineComponent({
  timer: Types.f32,     // 动画计时器（脉冲效果驱动）
  intensity: Types.f32, // DOT视觉强度 0~1（颜色叠加浓度）
  dotType: Types.ui8,   // 0=poison, 1=burn
});
