...
function enemyPortraitAssets() {
  const enemies = [
    ...
    ['dark_priest', 'dark priest enemy, pale robe, black halo, cursed healing staff'],
...
function enemySceneSubjects() {
  return [
    ...
    ['enemy_dark_priest', '96x96 dark priest enemy scene sprite, pale robe, black halo, cursed staff'],
