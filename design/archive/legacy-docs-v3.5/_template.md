...
> 一段话点明本文档的职责边界（≤ 60 字）。例如："本文档是塔升级机制的唯一权威。所有路径节点、SP 成本、UI 行为以此为准。"
...
|---|---|---|
| 三资源（能量/金币/技能点）v3.4 轴 | §x.y | ✅ 已同步 / 🔶 部分同步 / ❌ 未处理 |
| 工具栏部署 → 手牌区出卡 | §x.y | ✅ |
| 塔升级 L1-L5 → 关外科技树 | §x.y | ✅ |
| 毒藤塔/弩炮塔废弃 | §x.y | ✅ |
...
- 引用具体小节时优先用锚点，便于定位
- 引用 50-mda 时强制写明小节号，例如：`详见 [50-mda §17 技能点 SP](../50-data-numerical/50-mda.md#17-技能点sp获取与消费数值)`
