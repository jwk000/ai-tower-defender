...
### 13.10 技能点 SP 视觉（v3.4）

> 🛑 **v3.4 删除**：火花碎片视觉（菱形图标/入账动画/永久升级面板）整套废弃。替换为技能点 SP 显示。

| 元素 | 规格 |
|------|------|
| SP 图标 | 六角星形，青绿色 `#10B981 → #6EE7B7` |
| SP 计数器 | 关内顶栏右侧（商店/秘境面板打开时显示） |
| SP 获得动画 | 屏幕顶部弹出 "+N SP" 短暂提示，淡出 |
| SP 字体 | 16px Bold，青绿色 + 白色描边 |
